    ...
    <div className="body">
      <div className="container">
        ...
        <form onSubmit={redir}>
          ...
          <input type="text" id="card-number" placeholder="Enter your card number"></input>
        </div>
        <div class="form-group">
          <label for="card-name">Cardholder Name</label>
          <input type="text" id="card-name" placeholder="Enter cardholder name"></input>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" id="cvv" placeholder="Enter CVV"></input>
        </div>
          </div>
          ...
          <input type="text" id="upi-id" placeholder="Enter UPI ID"></input>
        </div>
          </div>
        ...
        <div class="form-group">
          ...
          <input type="text" id="netbanking-username" placeholder="Enter username"></input>
        </div>
        <div class="form-group">
          <label for="netbanking-password">Password</label>
          <input type="password" id="netbanking-password" placeholder="Enter password"></input>
        </div>
